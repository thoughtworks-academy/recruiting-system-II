          ...
          <div className="form-group">
            ...
            <div className="col-sm-4 col-md-4">
              <input type="text" className="form-control" id="inputSchool" placeholder="学校"
                     onChange={this.schoolChange} name="school" value={this.state.school}/>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-sm-4 col-md-4">
              <input type="text" className="form-control" id="inputName" placeholder="姓名"
                     onChange={this.nameChange} name="name" value={this.state.name}/>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-sm-4 col-md-4">
              <input type="text" className="form-control" id="inputMajor" placeholder="专业"
                     onChange={this.majorChange} name="major" value={this.state.major}/>
            </div>
            <div></div>
          </div>
